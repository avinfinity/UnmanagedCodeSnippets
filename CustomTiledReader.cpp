...
#define strcasecmp _stricmp
		...
		SoBufferObject*
			CustomTiledReader::readTile(int index, const SbBox3i32&)
		{
...
#define strcasecmp _stricmp
		...
		//Note that this method is not thread safe
		SoBufferObject*	 CustomTiledReader::readTile(int index, const SbBox3i32&)
		{
		...
		const imt::volume::VolumeTopoOctree* CustomTiledReader::topoTree() const
		{
		...
		SbBool			CustomTiledReader::isThreadSafe()
		{
			return SbBool(TRUE);
		}
