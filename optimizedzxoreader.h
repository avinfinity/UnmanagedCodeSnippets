#ifndef __IMT_OPTIMIZEDZXOREADER_H__
#define __IMT_OPTIMIZEDZXOREADER_H__
...
namespace imt{
	...
	class OptimizedZXOReader : public SoVolumeReader //SoVRLdmFileReader//
	{
		SO_FIELDCONTAINER_HEADER(OptimizedZXOReader);
