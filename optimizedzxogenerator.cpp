...
OptimizedZXOGenerator::OptimizedZXOGenerator() : _UpdateProgress(defaultProgressReporter)
{
	_Header._Minor = 0;
	_Header._Major = 1;
...
void OptimizedZXOGenerator::setVolumeInfo(int w, int h, int d, float voxelSizeX, float voxelSizeY, float voxelSizeZ, int bitDepth, int rawHeaderOffset, int dataType)
{
...
void OptimizedZXOGenerator::setVolumeInfo(const ZXOHeader& volumeInfo)
{
	//_Header = volumeInfo;

	memcpy(&_Header, &volumeInfo, sizeof(volumeInfo));

	_RawFileSkipSize = volumeInfo.headerSize;
...
void OptimizedZXOGenerator::setRawFilePath(std::string filePath, int skipHeaderSize)
{
...
void OptimizedZXOGenerator::setZXOFilePath(std::string zxoFilePath)
{
...
void OptimizedZXOGenerator::generate()
...
void OptimizedZXOGenerator::processLevel(int level)
{
...
void OptimizedZXOGenerator::processHighestResolutionLevel()
{
...
void OptimizedZXOGenerator::processHighestResolutionLevelFromImageCallBack()
{
	//first get the extended dimensions
	int extendedW = mLevelDimensions[0]._X;
	int extendedH = mLevelDimensions[0]._Y;
...
void OptimizedZXOGenerator::processHighestResolutionLevelWithSliceRead()
{
	//first get the extended dimensions
	int extendedW = mLevelDimensions[0]._X;
	int extendedH = mLevelDimensions[0]._Y;
...
void OptimizedZXOGenerator::sampleTile(const SbVec3i32& tileDim, int dataType, int border, const void* const octantTile[8], const int octantExists[8], void *parentTile)
{
...
void OptimizedZXOGenerator::getShiftAndHalfTileDim(SbVec2i32& shiftParentOctant, SbVec3i32& halfTileDim, const SbVec3i32& tileDim, int octant, int border) const
{
...
void OptimizedZXOGenerator::getRatio(SbVec3f &ratio, SbVec3i32 &shiftOctant, SbVec3i32 tileDim, SbVec3i32 halfTileDim, int octant, int border, const int octantExists[8]) const
{
...
void OptimizedZXOGenerator::buildLevelDimensions()
{
...
void OptimizedZXOGenerator::setProgressCallback(ProgressFunc& func, void *progressDataStructure)
{
...
void OptimizedZXOGenerator::setImageProviderCallback(ImageProviderFunc& func, void *imageProviderData)
{
...
void OptimizedZXOGenerator::setInputDataType(int inputDataType)
{
	_InputDataType = inputDataType;
}


void OptimizedZXOGenerator::getImage(int zz, unsigned short* data)
{
...
void OptimizedZXOGenerator::getImageRaw(int zz, unsigned short* data)
{
...
void defaultProgressReporter(const float& progress, void *dataStructure, void* OptimizedZXOGenerator)
{
	//empty function
}
...
OptimizedZXOGenerator::~OptimizedZXOGenerator()
{
	if (_TopoTree)
	{
		delete _TopoTree;
