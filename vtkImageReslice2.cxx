...
vtkStandardNewMacro(vtkImageReslice2);
vtkCxxSetObjectMacro(vtkImageReslice2, InformationInput, vtkImageData);
vtkCxxSetObjectMacro(vtkImageReslice2,ResliceAxes,vtkMatrix4x4);
vtkCxxSetObjectMacro(vtkImageReslice2,Interpolator,vtkAbstractImageInterpolator);
vtkCxxSetObjectMacro(vtkImageReslice2,ResliceTransform,vtkAbstractTransform);

//--------------------------------------------------------------------------
// typedef for pixel converter method
typedef void (vtkImageReslice2::*vtkImageReslice2ConvertScalarsType)(
...
typedef double vtkImageReslice2FloatingPointType;

//----------------------------------------------------------------------------
vtkImageReslice2::vtkImageReslice2()
{
...
//----------------------------------------------------------------------------
void vtkImageReslice2::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkImageReslice2::ReportReferences(vtkGarbageCollector* collector)
{
...
//----------------------------------------------------------------------------
void vtkImageReslice2::SetOutputSpacing(double x, double y, double z)
{
...
//----------------------------------------------------------------------------
void vtkImageReslice2::SetOutputSpacingToDefault()
{
...
//----------------------------------------------------------------------------
void vtkImageReslice2::SetOutputOrigin(double x, double y, double z)
{
...
//----------------------------------------------------------------------------
void vtkImageReslice2::SetOutputOriginToDefault()
{
...
//----------------------------------------------------------------------------
void vtkImageReslice2::SetOutputExtent(int a, int b, int c, int d, int e, int f)
{
...
//----------------------------------------------------------------------------
void vtkImageReslice2::SetOutputExtentToDefault()
{
...
//----------------------------------------------------------------------------
const char *vtkImageReslice2::GetInterpolationModeAsString()
{
...
//----------------------------------------------------------------------------
const char *vtkImageReslice2::GetSlabModeAsString()
{
...
//----------------------------------------------------------------------------
void vtkImageReslice2::SetStencilData(vtkImageStencilData *stencil)
{
  this->SetInputData(1, stencil);
}

//----------------------------------------------------------------------------
vtkImageStencilData *vtkImageReslice2::GetStencil()
{
...
//----------------------------------------------------------------------------
void vtkImageReslice2::SetStencilOutput(vtkImageStencilData *output)
{
  this->GetExecutive()->SetOutputData(1, output);
}

//----------------------------------------------------------------------------
vtkImageStencilData *vtkImageReslice2::GetStencilOutput()
{
...
//----------------------------------------------------------------------------
void vtkImageReslice2::SetResliceAxesDirectionCosines(double x0, double x1,
                                                     double x2, double y0,
                                                     double y1, double y2,
                                                     double z0, double z1,
                                                     double z2)
...
//----------------------------------------------------------------------------
void vtkImageReslice2::GetResliceAxesDirectionCosines(double xdircos[3],
                                                     double ydircos[3],
                                                     double zdircos[3])
{
  if (!this->ResliceAxes)
...
//----------------------------------------------------------------------------
void vtkImageReslice2::SetResliceAxesOrigin(double x, double y, double z)
{
  if (!this->ResliceAxes)
  {
    // consistent registers/unregisters
...
//----------------------------------------------------------------------------
void vtkImageReslice2::GetResliceAxesOrigin(double origin[3])
{
  if (!this->ResliceAxes)
  {
...
//----------------------------------------------------------------------------
vtkAbstractImageInterpolator *vtkImageReslice2::GetInterpolator()
{
...
vtkMTimeType vtkImageReslice2::GetMTime()
{
...
//----------------------------------------------------------------------------
int vtkImageReslice2::ConvertScalarInfo(
...
//----------------------------------------------------------------------------
void vtkImageReslice2::ConvertScalars(
...
//----------------------------------------------------------------------------
int vtkImageReslice2::RequestUpdateExtent(
...
//----------------------------------------------------------------------------
int vtkImageReslice2::FillInputPortInformation(int port, vtkInformation *info)
{
  if (port == 1)
  {
...
//----------------------------------------------------------------------------
int vtkImageReslice2::FillOutputPortInformation(int port, vtkInformation* info)
{
  if (port == 1)
  {
...
//----------------------------------------------------------------------------
void vtkImageReslice2::AllocateOutputData(vtkImageData *output,
...
//----------------------------------------------------------------------------
vtkImageData *vtkImageReslice2::AllocateOutputData(vtkDataObject *output,
                                                  vtkInformation* outInfo)
{
...
//----------------------------------------------------------------------------
void vtkImageReslice2::GetAutoCroppedOutputBounds(vtkInformation *inInfo,
                                                 double bounds[6])
{
  int i, j;
...
//----------------------------------------------------------------------------
int vtkImageReslice2::RequestInformation(
  vtkInformation *vtkNotUsed(request),
  vtkInformationVector **inputVector,
  vtkInformationVector *outputVector)
{
  ...
  //this->TransformInputSampling = 0;

  std::cout << " in center : " << inCenter[0] << " " << inCenter[1] << " " << inCenter[2] << " " << this->TransformInputSampling << std::endl;
...
struct vtkImageReslice2Conversion
{
  static void Convert(
...
template <class F, class T>
void vtkImageReslice2Conversion<F, T>::Convert(
...
template <class F, class T>
void vtkImageReslice2Conversion<F, T>::Clamp(
  void *&outPtr0, const F *inPtr, int numscalars, int n)
{
  T* outPtr = static_cast<T*>(outPtr0);
  ...
  bool forceClamping)
{
  ...
  if (forceClamping && dataType != VTK_FLOAT && dataType != VTK_DOUBLE)
  {
    ...
    switch (dataType)
    {
      vtkTemplateAliasMacro(
        *conversion = &(vtkImageReslice2Conversion<F, VTK_TT>::Clamp)
        );
      default:
        *conversion = 0;
    }
  ...
  else
  {
    ...
    {
      vtkTemplateAliasMacro(
        *conversion = &(vtkImageReslice2Conversion<F, VTK_TT>::Convert)
        );
      default:
        *conversion = 0;
    }
...
template<class F>
struct vtkImageReslice2Composite
{
...
template<class F>
void vtkImageReslice2SlabSum(F *inPtr, int numscalars, int n, F f)
{
  int m = numscalars;
  --n;
  do
...
template<class F>
void vtkImageReslice2SlabTrap(F *inPtr, int numscalars, int n, F f)
{
  int m = numscalars;
  --n;
  do
...
template <class F>
void vtkImageReslice2Composite<F>::MeanValue(F *inPtr, int numscalars, int n)
{
  F f = 1.0/n;
  vtkImageReslice2SlabSum(inPtr, numscalars, n, f);
}

template <class F>
void vtkImageReslice2Composite<F>::MeanTrap(F *inPtr, int numscalars, int n)
{
  F f = 1.0/(n-1);
  vtkImageReslice2SlabTrap(inPtr, numscalars, n, f);
}

template <class F>
void vtkImageReslice2Composite<F>::SumValues(F *inPtr, int numscalars, int n)
{
  vtkImageReslice2SlabSum(inPtr, numscalars, n, static_cast<F>(1.0));
}

template <class F>
void vtkImageReslice2Composite<F>::SumTrap(F *inPtr, int numscalars, int n)
{
  vtkImageReslice2SlabTrap(inPtr, numscalars, n, static_cast<F>(1.0));
}

template <class F>
void vtkImageReslice2Composite<F>::MinValue(F *inPtr, int numscalars, int n)
{
  int m = numscalars;
  --n;
  do
...
template <class F>
void vtkImageReslice2Composite<F>::MaxValue(F *inPtr, int numscalars, int n)
{
  int m = numscalars;
  --n;
  do
  ...
  int slabMode, int trpz)
{
  ...
  {
    case VTK_IMAGE_SLAB_MIN:
      *composite = &(vtkImageReslice2Composite<F>::MinValue);
      break;
    case VTK_IMAGE_SLAB_MAX:
      *composite = &(vtkImageReslice2Composite<F>::MaxValue);
      break;
    case VTK_IMAGE_SLAB_MEAN:
      if (trpz) { *composite = &(vtkImageReslice2Composite<F>::MeanTrap); }
      else { *composite = &(vtkImageReslice2Composite<F>::MeanValue); }
      break;
    case VTK_IMAGE_SLAB_SUM:
      if (trpz) { *composite = &(vtkImageReslice2Composite<F>::SumTrap); }
      else { *composite = &(vtkImageReslice2Composite<F>::SumValues); }
      break;
    default:
      *composite = 0;
  }
...
inline int vtkImageReslice2PointerAlignment(void *ptr, int n)
{
...
template <class T>
struct vtkImageReslice2SetPixels
{
  ...
  int dataType, int dataSize, int numscalars, void *dataPtr)
{
  ...
  if (vtkImageReslice2PointerAlignment(dataPtr, 4) &&
      ...
      dataSize < 4 && dataSize*numscalars <= 16)
  {
    ...
    {
      case 1:
        *setpixels = &vtkImageReslice2SetPixels<vtkTypeInt32>::Set1;
        break;
      case 2:
        *setpixels = &vtkImageReslice2SetPixels<vtkTypeInt32>::Set2;
        break;
      case 3:
        *setpixels = &vtkImageReslice2SetPixels<vtkTypeInt32>::Set3;
        break;
      case 4:
        *setpixels = &vtkImageReslice2SetPixels<vtkTypeInt32>::Set4;
        break;
      default:
        *setpixels = 0;
        break;
  ...
  switch (numscalars)
  {
    case 1:
      ...
      {
        vtkTemplateAliasMacro(
          *setpixels = &vtkImageReslice2SetPixels<VTK_TT>::Set1
          );
        default:
          *setpixels = 0;
      }
    ...
    case 2:
      ...
      {
        vtkTemplateAliasMacro(
          *setpixels = &vtkImageReslice2SetPixels<VTK_TT>::Set2
          );
        default:
          *setpixels = 0;
      }
    ...
    case 3:
      ...
      {
        vtkTemplateAliasMacro(
          *setpixels = &vtkImageReslice2SetPixels<VTK_TT>::Set3
          );
        default:
          *setpixels = 0;
      }
    ...
    case 4:
      ...
      {
        vtkTemplateAliasMacro(
          *setpixels = &vtkImageReslice2SetPixels<VTK_TT>::Set4
          );
        default:
          *setpixels = 0;
      }
    ...
    default:
      ...
      {
        vtkTemplateAliasMacro(
          *setpixels = &vtkImageReslice2SetPixels<VTK_TT>::Set
          );
        default:
          *setpixels = 0;
      }
...
template<class F>
void vtkImageReslice2RescaleScalars(F *floatData, int components, int n,
...
void vtkImageReslice2ClearExecute(vtkImageReslice2 *self,
...
template<class F>
void vtkImageReslice2Execute(vtkImageReslice2 *self,
                            vtkDataArray *scalars,
                            vtkAbstractImageInterpolator *interpolator,
                            vtkImageData *outData, void *outPtr,
                            double scalarShift, double scalarScale,
                            vtkImageReslice2ConvertScalarsType convertScalars,
  ...
  for (; !iter.IsAtEnd(); iter.NextSpan())
  {
    ...
    else
    {
      ...
      if (!optimizeNearest)
      {
        ...
        while (startIdX <= idXmax)
        {
          ...
          if (wasInBounds)
          {
            ...
            if (rescaleScalars)
            {
              vtkImageReslice2RescaleScalars(floatPtr, inComponents,
                                            idXmax - idXmin + 1,
      ...
      else // optimize for nearest-neighbor interpolation
      {
		...
		//std::cout << inExtX << " " << inExtY << " " << inExtZ << std::endl;
        ...
        for (int iidX = idXmin; iidX <= idXmax; iidX++)
        {
              ...
              inIdZ >= 0 && inIdZ < inExtZ)
          {
			...
			//std::cout << idXmax - endIdX << std::endl;
...
template <class T>
struct vtkImageReslice2RowInterpolate
{
  static void Nearest(
...
template<class T>
void vtkImageReslice2RowInterpolate<T>::Nearest(
...
template<class T>
void vtkImageReslice2RowInterpolate<T>::Nearest1(
  void *&outPtr0, int idX, int idY, int idZ, int, int n,
  vtkInterpolationWeights *weights)
{
  const vtkIdType *iX = weights->Positions[0] + idX;
...
template<class T>
void vtkImageReslice2RowInterpolate<T>::Nearest2(
  void *&outPtr0, int idX, int idY, int idZ, int, int n,
  vtkInterpolationWeights *weights)
{
  const vtkIdType *iX = weights->Positions[0] + idX;
...
template<class T>
void vtkImageReslice2RowInterpolate<T>::Nearest3(
  void *&outPtr0, int idX, int idY, int idZ, int, int n,
  vtkInterpolationWeights *weights)
{
  const vtkIdType *iX = weights->Positions[0] + idX;
...
template<class T>
void vtkImageReslice2RowInterpolate<T>::Nearest4(
  void *&outPtr0, int idX, int idY, int idZ, int, int n,
  vtkInterpolationWeights *weights)
{
  const vtkIdType *iX = weights->Positions[0] + idX;
  ...
  int scalarType, int numScalars)
{
  *summation = 0;
  ...
  if (numScalars == 1)
  {
    ...
    {
      vtkTemplateAliasMacro(
        *summation = &(vtkImageReslice2RowInterpolate<VTK_TT>::Nearest1)
        );
      default:
        *summation = 0;
    }
  ...
  else if (numScalars == 2)
  {
    ...
    {
      vtkTemplateAliasMacro(
        *summation = &(vtkImageReslice2RowInterpolate<VTK_TT>::Nearest2)
        );
      default:
        *summation = 0;
    }
  ...
  else if (numScalars == 3)
  {
    ...
    {
      vtkTemplateAliasMacro(
        *summation = &(vtkImageReslice2RowInterpolate<VTK_TT>::Nearest3)
        );
      default:
        *summation = 0;
    }
  ...
  else if (numScalars == 4)
  {
    ...
    {
      vtkTemplateAliasMacro(
        *summation = &(vtkImageReslice2RowInterpolate<VTK_TT>::Nearest4)
        );
      default:
        *summation = 0;
    }
  ...
  else
  {
    ...
    {
      vtkTemplateAliasMacro(
        *summation = &(vtkImageReslice2RowInterpolate<VTK_TT>::Nearest)
        );
      default:
        *summation = 0;
    }
...
//----------------------------------------------------------------------------
template<class F>
struct vtkImageReslice2RowComp
{
...
template<class F>
void vtkImageReslice2RowComp<F>::SumRow(
...
template<class F>
void vtkImageReslice2RowComp<F>::SumRowTrap(
...
template<class F>
void vtkImageReslice2RowComp<F>::MeanRow(
  F *outPtr, const F *inPtr, int numComp, int count, int i, int n)
{
  int m = count*numComp;
  if (m)
...
template<class F>
void vtkImageReslice2RowComp<F>::MeanRowTrap(
  F *outPtr, const F *inPtr, int numComp, int count, int i, int n)
{
  int m = count*numComp;
  if (m)
...
template<class F>
void vtkImageReslice2RowComp<F>::MinRow(
  F *outPtr, const F *inPtr, int numComp, int count, int i, int)
{
  int m = count*numComp;
  if (m)
...
template<class F>
void vtkImageReslice2RowComp<F>::MaxRow(
  F *outPtr, const F *inPtr, int numComp, int count, int i, int)
{
  int m = count*numComp;
  if (m)
  ...
  int slabMode, int trpz)
{
  ...
  {
    case VTK_IMAGE_SLAB_MIN:
      *composite = &(vtkImageReslice2RowComp<F>::MinRow);
      break;
    case VTK_IMAGE_SLAB_MAX:
      *composite = &(vtkImageReslice2RowComp<F>::MaxRow);
      break;
    case VTK_IMAGE_SLAB_MEAN:
      if (trpz) { *composite = &(vtkImageReslice2RowComp<F>::MeanRowTrap); }
      else { *composite = &(vtkImageReslice2RowComp<F>::MeanRow); }
      break;
    case VTK_IMAGE_SLAB_SUM:
      if (trpz) { *composite = &(vtkImageReslice2RowComp<F>::SumRowTrap); }
      else { *composite = &(vtkImageReslice2RowComp<F>::SumRow); }
      break;
    default:
...
template <class F>
void vtkReslicePermuteExecute(vtkImageReslice2 *self,
                              vtkDataArray *scalars,
                              vtkAbstractImageInterpolator *interpolator,
                              vtkImageData *outData, void *outPtr,
                              double scalarShift, double scalarScale,
    ...
    for (; !iter.IsAtEnd(); iter.NextSpan())
    {
      ...
      else
      {
        ...
        if (doConversion)
        {
          ...
          if (rescaleScalars)
          {
            vtkImageReslice2RescaleScalars(floatPtr, inComponents, span,
                                          scalarShift, scalarScale);
          }
...
vtkMatrix4x4 *vtkImageReslice2::GetIndexMatrix(vtkInformation *inInfo,
                                              vtkInformation *outInfo)
{
...
int vtkImageReslice2::RequestData(
...
void vtkImageReslice2::ThreadedRequestData(
  vtkInformation *vtkNotUsed(request),
  ...
  int outExt[6], int threadId)
{
  ...
  outData[0]->GetExtent(outExt);

  std::cout << oExt[0] << " " << oExt[1] << " " << oExt[2] << " " << oExt[3] << " " << oExt[4] << " " << oExt[5] << std::endl;
  ...
  vtkImageReslice2FloatingPointType newmat[4][4];
  for (int i = 0; i < 4; i++)
  {
  ...
  {
    vtkImageReslice2ClearExecute(this, outData[0], outPtr, outExt, threadId);
  }
  else if (this->UsePermuteExecute)
  {
    vtkReslicePermuteExecute(this, scalars, this->Interpolator,
                             ...
                             (this->HasConvertScalars ?
                                &vtkImageReslice2::ConvertScalarsBase : 0),
                             outExt, threadId, newmat);
  }
  else
  {
    vtkImageReslice2Execute(this, scalars, this->Interpolator,
                           outData[0], outPtr,
                           this->ScalarShift, this->ScalarScale,
                           (this->HasConvertScalars ?
                              &vtkImageReslice2::ConvertScalarsBase : 0),
