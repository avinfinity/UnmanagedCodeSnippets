...
# the source (default to /usr/local/dicom/)
...
foreach(lib
  ...
  if (NOT DCMTK_${lib}_LIBRARY_DEBUG)
    find_library(DCMTK_${lib}_LIBRARY_DEBUG
    "${lib}"
    PATHS
    "${DCMTK_DIR}/${lib}/libsrc/Debug"
    ${DCMTK_DIR}/lib)
  endif (NOT DCMTK_${lib}_LIBRARY_DEBUG)
  ...
  elseif(DCMTK_${lib}_LIBRARY)
    # there is no special debug library, so we use the default
    list(APPEND DCMTK_LIBRARIES debug ${DCMTK_${lib}_LIBRARY})
  endif()
endforeach()
