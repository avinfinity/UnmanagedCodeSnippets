...
=========================================================================*/
// .NAME vtkModifiedCutter - Cut vtkDataSet with user-specified implicit function
// .SECTION Description
// vtkModifiedCutter is a filter to cut through data using any subclass of
...
//
// vtkModifiedCutter is generally used to "slice-through" a dataset, generating
// a surface that can be visualized. It is also possible to use vtkModifiedCutter
// to do a form of volume rendering. vtkModifiedCutter does this by generating
...
#ifndef vtkModifiedCutter_h
#define vtkModifiedCutter_h
...
class VTKFILTERSCORE_EXPORT vtkModifiedCutter : public vtkPolyDataAlgorithm
{
public:
  vtkTypeMacro(vtkModifiedCutter,vtkPolyDataAlgorithm);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Construct with user-specified implicit function; initial value of 0.0; and
  // generating cut scalars turned off.
  static vtkModifiedCutter *New();
...
protected:
  vtkModifiedCutter(vtkImplicitFunction *cf=NULL);
  ~vtkModifiedCutter();
...
private:
  vtkModifiedCutter(const vtkModifiedCutter&);  // Not implemented.
  void operator=(const vtkModifiedCutter&);  // Not implemented.
};

// Description:
// Return the sorting procedure as a descriptive character string.
inline const char *vtkModifiedCutter::GetSortByAsString(void)
{
