...
=========================================================================*/
/**
 * @class   vtkImageReslice2
 * @brief   Reslices a volume along a new set of axes.
 *
 * vtkImageReslice2 is the swiss-army-knife of image geometry filters:
 ...
 * tasks that vtkImageReslice2 is well suited for:
...
#ifndef vtkImageReslice2_h
#define vtkImageReslice2_h
...
class VTKIMAGINGCORE_EXPORT vtkImageReslice2 : public vtkThreadedImageAlgorithm
{
public:
  static vtkImageReslice2 *New();
  vtkTypeMacro(vtkImageReslice2, vtkThreadedImageAlgorithm);
...
private:
  vtkImageReslice2(const vtkImageReslice2&) VTK_DELETE_FUNCTION;
  void operator=(const vtkImageReslice2&) VTK_DELETE_FUNCTION;
};
