#ifndef __IMT_OPTIMIZEDZXOGENERATOR_H__
#define __IMT_OPTIMIZEDZXOGENERATOR_H__
...
void defaultProgressReporter(const float& progress, void *dataStructure, void* OpetimizedZXOGenerator);

void defaultImageProvider(const int&, void*);



class OptimizedZXOGenerator
{
public:
	...
	void setVolumeInfo(const ZXOHeader& volumeInfo);
