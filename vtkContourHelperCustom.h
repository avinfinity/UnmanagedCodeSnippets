...
#ifndef vtkContourHelperCustom_h
#define vtkContourHelperCustom_h
...
class  vtkContourHelperCustom
{
public:
	vtkContourHelperCustom(vtkIncrementalPointLocator *locator,
                 vtkCellArray *verts,
                 vtkCellArray *lines,
                 vtkCellArray* polys,
                 vtkPointData *inPd,
  ...
  ~vtkContourHelperCustom();
  void Contour(vtkCell* cell, double value, vtkDataArray *cellScalars, vtkIdType cellId);

 private:
  // Not implemented
	 vtkContourHelperCustom(const vtkContourHelperCustom&);
	 vtkContourHelperCustom& operator=(const vtkContourHelperCustom&);
