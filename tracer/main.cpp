...
int main(int argc, const char* argv[]) {
	...
	Mesh mesh("/media/data/projects/project_data/Models/Dragon1/dragon1.obj", false);
	...
	Bvh bvh(mesh);
	std::cout << "done." <<bvh.getDepth()<<" "<<bvh.getNumNodes()<<" "<< ( clock() - time ) / CLOCKS_PER_SEC<< std::endl;
